...
export default function TelegramBotPage() {
  ...
  // Secret combination to access admin tab (Ctrl+Shift+A)
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 min-h-screen flex flex-col">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            {activeTab === "admin" && (
              <Button 
                variant="outline" 
                className="text-sm bg-yellow-950 border-yellow-800 text-yellow-500 hover:text-yellow-400"
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full mb-6">
          ...
          <TabsContent value="admin">
            <div className="space-y-6">
              <Card className="border-yellow-700/30 bg-yellow-950/10">
                <CardHeader>
                  ...
                  <CardDescription className="text-yellow-300/70">
                    Configure the Telegram bot and other administrative settings
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <Alert className="bg-yellow-900/20 border border-yellow-700 mb-6">
                    <AlertCircle className="h-4 w-4 text-yellow-400" />
                    <AlertDescription className="text-yellow-200">
                      This is an administrative area. Configure the Telegram bot by providing a valid bot token below.
                    </AlertDescription>
                  </Alert>
      ...
      <footer className="py-6 mt-8 border-t border-gray-800 text-muted text-sm">
        ...
        <div className="mt-2 text-xs text-muted-foreground/50 text-center">
          Press Ctrl+Shift+A to access administrator settings
        </div>
      </footer>
    </div>
  );
